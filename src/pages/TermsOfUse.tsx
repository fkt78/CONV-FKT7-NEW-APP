...
export default function TermsOfUse() {
  return (
    <LegalPageLayout title="利用規約">
      ...
      <section>
        <h2 className="text-[#1d1d1f] font-semibold text-base mt-6 mb-2">第6条（退会・アカウント削除）</h2>
        <p>
      ...
      <section>
        <h2 className="text-[#1d1d1f] font-semibold text-base mt-6 mb-2">第7条（反社会的勢力の排除）</h2>
        <p>
      ...
      <section>
        <h2 className="text-[#1d1d1f] font-semibold text-base mt-6 mb-2">第8条（サービスの変更・中止）</h2>
        <p>
      ...
      <section>
        <h2 className="text-[#1d1d1f] font-semibold text-base mt-6 mb-2">第9条（免責）</h2>
        <p>
      ...
      <section>
        <h2 className="text-[#1d1d1f] font-semibold text-base mt-6 mb-2">第10条（規約の変更）</h2>
        <p>
      ...
      <section>
        <h2 className="text-[#1d1d1f] font-semibold text-base mt-6 mb-2">第11条（準拠法・管轄）</h2>
        <p>
