...
export default function TermsOfUse() {
  return (
    <LegalPageLayout title="利用規約">
      ...
      <section>
        <h2 className="text-[#1d1d1f] font-semibold text-base mt-6 mb-2">第1条（適用）</h2>
        <p>
      ...
      <section>
        <h2 className="text-[#1d1d1f] font-semibold text-base mt-6 mb-2">第2条（会員登録）</h2>
        <p>
      ...
      <section>
        <h2 className="text-[#1d1d1f] font-semibold text-base mt-6 mb-2">第3条（禁止事項）</h2>
        <p>
      ...
      <section>
        <h2 className="text-[#1d1d1f] font-semibold text-base mt-6 mb-2">第4条（知的財産権）</h2>
        <p>
      ...
      <section>
        <h2 className="text-[#1d1d1f] font-semibold text-base mt-6 mb-2">第6条（広告・宣伝・アフィリエイト等）</h2>
        <p>
          当店は、本アプリ上に、当店又は第三者の広告、宣伝、バナー、成果報酬型の紹介リンク（いわゆるアフィリエイトリンクを含む）を掲載することがあります。
          掲載の有無、内容、掲載期間、掲載位置は当店の裁量により変更することがあります。
        </p>
        <p className="mt-2">
          当該表示の詳細な方針は、
        ...
        <p className="mt-2">
          アフィリエイトリンク等を経由して第三者のサービス・商品をご利用された場合、当該取引は会員様と当該第三者との間で行われるものとし、当店は当該取引に関して責任を負いません（当店が商品・サービスを直接提供する場合を除きます）。
        </p>
      </section>

      <section>
        <h2 className="text-[#1d1d1f] font-semibold text-base mt-6 mb-2">第7条（退会・アカウント削除）</h2>
        <p>
      ...
      <section>
        <h2 className="text-[#1d1d1f] font-semibold text-base mt-6 mb-2">第8条（反社会的勢力の排除）</h2>
        <p>
      ...
      <section>
        <h2 className="text-[#1d1d1f] font-semibold text-base mt-6 mb-2">第9条（サービスの変更・中止）</h2>
        <p>
      ...
      <section>
        <h2 className="text-[#1d1d1f] font-semibold text-base mt-6 mb-2">第10条（免責）</h2>
        <p>
      ...
      <section>
        <h2 className="text-[#1d1d1f] font-semibold text-base mt-6 mb-2">第11条（規約の変更）</h2>
        <p>
      ...
      <section>
        <h2 className="text-[#1d1d1f] font-semibold text-base mt-6 mb-2">第12条（準拠法・管轄）</h2>
        <p>
      ...
      <div className="text-[#86868b] text-xs mt-8 space-y-1">
        ...
        <p>改定日：2026年3月（広告・宣伝・アフィリエイト等に関する条項の追加）</p>
      </div>
    </LegalPageLayout>
  )
}
