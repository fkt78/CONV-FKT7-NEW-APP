        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label htmlFor="reg-name" className="block text-[#86868b] text-[15px] font-medium mb-2 tracking-wide">
              お名前（フルネーム） <span className="text-[#0095B6]">*</span>
            </label>
            <input
              id="reg-name"
              type="text"
          ...
          <div>
            <label htmlFor="reg-birth" className="block text-[#86868b] text-[15px] font-medium mb-2 tracking-wide">
              生年月 <span className="text-[#0095B6]">*</span>
            </label>
            <input
              id="reg-birth"
              type="month"
          ...
          <div>
            <label htmlFor="reg-attribute" className="block text-[#86868b] text-[15px] font-medium mb-2 tracking-wide">
              属性 <span className="text-[#0095B6]">*</span>
            </label>
            <select
              id="reg-attribute"
              value={attribute}
          ...
          <div>
            <label htmlFor="reg-email" className="block text-[#86868b] text-[15px] font-medium mb-2 tracking-wide">
              メールアドレス <span className="text-[#0095B6]">*</span>
            </label>
            <input
              id="reg-email"
              type="email"
          ...
          <div>
            <label htmlFor="reg-password" className="block text-[#86868b] text-[15px] font-medium mb-2 tracking-wide">
              パスワード <span className="text-[#0095B6]">*</span>
            </label>
            <input
              id="reg-password"
              type="password"
          ...
          <label className="flex items-start gap-4 cursor-pointer group min-h-[44px]">
            ...
            <span className="text-[#1d1d1f] text-[15px] leading-relaxed">
              <Link to="/terms" className="text-[#0095B6] underline hover:text-[#007A96]" target="_blank">
                利用規約
              </Link>
              および
              <Link to="/privacy" className="text-[#0095B6] underline hover:text-[#007A96]" target="_blank">
                プライバシーポリシー
              </Link>
              に同意する <span className="text-[#0095B6]">*</span>
            </span>
          </label>
