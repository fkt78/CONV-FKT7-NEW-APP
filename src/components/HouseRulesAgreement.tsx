...
export default function HouseRulesAgreement() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-[#0a0a0f] flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto overscroll-contain">
        <div className="max-w-lg mx-auto px-5 py-6 pb-8">
          ...
          <div className="text-center mb-8">
            <span className="text-amber-400 text-4xl block mb-3">♛</span>
            <h1 className="text-amber-400 font-bold text-xl tracking-[0.2em] leading-tight">
              FKT7へようこそ
            </h1>
            <p className="text-amber-400/80 text-sm tracking-widest mt-2">
              －特別な空間へご案内いたします－
            </p>
          </div>
          ...
          <div className="space-y-6 text-white/85 text-sm leading-relaxed">
            ...
            <div className="border-l-2 border-amber-400/40 pl-4 space-y-3">
              <h2 className="text-amber-400 font-bold text-base">1. 希少商品の「特別なご案内」とご予約について</h2>
              <p>
                当店に入荷する数量限定の特殊な商品につきましては、FKT7メンバーの皆様を最優先といたします。
              </p>
              <ul className="list-disc list-inside space-y-1.5 text-white/75">
                <li><strong className="text-white/90">ご予約の配分について：</strong>より多くのお客様に公平に喜んでいただけるよう、ご予約の割り当ては「当店の裁量」にて調整させていただく場合がございます。</li>
                <li><strong className="text-white/90">商品のお渡しについて：</strong>極めて特殊な商品ゆえに、予期せぬ未入荷等のトラブルにより、万が一お渡しが叶わない可能性もございます。誠意をもって対応いたしますが、あらかじめ特別な商品である性質をご理解ください。</li>
              </ul>
            </div>

            <div className="border-l-2 border-amber-400/40 pl-4 space-y-3">
              <h2 className="text-amber-400 font-bold text-base">2. 徹底した「秘密厳守」と「アプリ内完結」のお願い</h2>
              <p>
                FKT7は、お客様と店舗スタッフの「信義」によって成り立つシークレットな空間です。
              </p>
              <ul className="list-disc list-inside space-y-1.5 text-white/75">
                <li><strong className="text-white/90">お問い合わせ窓口の限定：</strong>特殊な商品に関する店舗へのお電話でのご確認や、店頭スタッフへの直接のお問い合わせは固くお断りいたします。情報の機密性を守るため、やり取りはすべて【本アプリ内のみ】とさせていただきます。</li>
                <li><strong className="text-white/90">お受け取りについて：</strong>商品お渡しのご案内（お約束）をさせていただいた当日、もしくは翌日〜翌々日までにはお受け取りをお願いいたします。ご都合が悪い場合は、アプリより明確なご来店予定日をお知らせください。</li>
                <li><strong className="text-white/90">ご返信について：</strong>本アプリは店舗スタッフが直接対応しております。専属のオペレーターではないため、ご連絡にお時間をいただく場合がございます。温かいご配慮をお願いいたします。</li>
              </ul>
            </div>

            <div className="border-l-2 border-amber-400/40 pl-4 space-y-3">
              <h2 className="text-amber-400 font-bold text-base">3. FKT7のフル活用とサポート</h2>
              <p>
      ...
      {/* 固定ボタンエリア */}
      <div className="flex-shrink-0 px-5 py-4 bg-[#0a0a0f] border-t border-amber-400/10 safe-area-bottom">
        <button
